...
<div class="container">
    ...
    <div class="col-md-12 text-center infinite-scroll px-0">
        @forelse($myposts as $post)
            <div id="post-{{$post->id}}" class="card col-lg-10 mx-auto d-flex flex-row px-0" style="max-width: 800px">
                ...
                <div class="col p-0 d-flex flex-column overflow-auto">
                    ...
                    <!-- <a href="@guest {{route('login')}} @else # @endguest" class="text-decoration-none mr-2"><i class="fas fa-crown mr-1"></i>Give Award</a> -->
                        ...
                        @endif
                        <a href="@guest {{route('login')}} @else {{ route('post.delete', $post) }} @endguest" class="text-decoration-none mr-2 text-danger delete"><i class="fa fa-exclamation-triangle"></i> Delete</a>
                    </div>
                </div>
            </div>
        @empty

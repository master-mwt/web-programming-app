...
@push('scripts')
    <script>
        $(document).ready(function () {
            /* CSS setting */
            $('#table-log').css('font-size', '0.85rem');
            $('.date').css('min-width', '75px');
            $('.text').css('word-break', 'break-all');
            $('a.llv-active').css({'z-index': '2', 'background-color': '#f5f5f5', 'border-color': '#777'});
            $('.list-group-item').css('word-wrap', 'break-word');
            $('.folder').css('padding-top', '15px');
            $('.div-scroll').css({'height': '80vh', 'overflow': 'hidden auto'});

        ...
        <div class="col-md-12 text-center px-0">
            <div class="card col-lg-10 mx-auto d-flex flex-row px-0" style="max-width: 800px">
                ...
                <div class="col p-0 d-flex flex-column overflow-auto">
                    ...
                    <div id="postcarousel-{{$post->id}}" class="carousel slide overflow-hidden" data-ride="carousel" style="max-width:800px;">
                    ...
                    <!-- <a href="@guest {{route('login')}} @else # @endguest" class="text-decoration-none mr-2"><i class="fas fa-crown mr-1"></i>Give Award</a> -->
                        ...
                        @if($post->reported == 'Report')
                            <a id="post-{{ $post->id }}-report" href="@guest {{route('login')}} @else {{ route('post.report', $post) }} @endguest" class="text-decoration-none report"><i id="post-{{ $post->id }}-report-icon" class="far fa-flag mr-1"></i>Report Post</a>
                        @elseif($post->reported == 'Unreport')
                            <a id="post-{{ $post->id }}-report" href="@guest {{route('login')}} @else {{ route('post.report', $post) }} @endguest" class="text-decoration-none text-danger report"><i id="post-{{ $post->id }}-report-icon" class="fas fa-flag mr-1"></i>Unreport Post</a>
                        @else
                            <a href="{{route('login')}}" class="text-decoration-none"><i class="far fa-flag mr-1"></i>Report Post</a>
                        @endif
                    </div>
                </div>
            </div>
